"""Add draft_payload to actions

Revision ID: 8a1a8212fdd4
Revises: ad18522944c1
Create Date: 2026-05-01 21:26:37.970685
...
revision: str = '8a1a8212fdd4'
down_revision: Union[str, Sequence[str], None] = 'ad18522944c1'
...
def upgrade() -> None:
    ...
    op.add_column('actions', sa.Column('draft_payload', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('actions', 'draft_payload')
