...
export default function WorkspacesPage() {
    ...
    const handleCreate = async () => {
        ...
        try {
            const ws = await createWorkspace(token, newName.trim(), newDesc.trim() || undefined, orgSlug || undefined);
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1">Manage your deal folders and documents</p>
                </div>
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    {ws.description && (
                                        <p className="text-slate-400 text-sm mt-1">{ws.description}</p>
                                    )}
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <Badge color={statusColor(ws.intelligence_status)}>
